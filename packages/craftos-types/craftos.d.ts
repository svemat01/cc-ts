// Modified version of @jackmacwindows/craftos-types to correct some types
...
declare namespace rednet {
    ...
    function send<Message extends any = any>(
        recipient: number,
        message: Message,
        protocol?: string,
    ): void;
    function receive<Message extends any = any>(
        filter?: string | null,
        timeout?: number,
    ): LuaMultiReturn<[number, Message, string | null] | [null]>;
    function lookup(protocol: string, hostname: string): number;
    function lookup(protocol: string): number[];
    function broadcast<Message extends any>(
        message: Message,
        protocol?: string,
    ): void;
}
...
type SettingOptions<T extends any = any> = {
    description?: string;
    default?: T;
    type?: string;
};
...
declare namespace settings {
    ...
    function set<T extends any = any>(name: string, value: T): void;
    function get<T extends any = any>(name: string, defaultValue: T): T;
    function get<T extends any = any>(name: string): T | undefined;
