...
export class CharEvent implements IEvent {
    ...
    public get_name() {return "char" as const;}
...
export class PasteEvent implements IEvent {
    ...
    public get_name() {return "paste" as const;}
...
export class TaskCompleteEvent implements IEvent {
    ...
    public get_name() {return "task_complete" as const;}
    public get_args() {
...
export class RedstoneEvent implements IEvent {
    ...
    public get_name() {return "redstone" as const;}
...
export class TerminateEvent implements IEvent {
    ...
    public get_name() {return "terminate" as const;}
    public get_args() {return [];}
    public static init(args: any[]): IEvent | null {
...
export class RednetMessageEvent<Message extends any = any> implements IEvent {
    ...
    public get_name() {return "rednet_message" as const;}
...
export class ModemMessageEvent implements IEvent {
    ...
    public get_name() {return "modem_message" as const;}
...
export class MouseEvent implements IEvent {
    ...
    public get_name() {
        ...
        }[this.type] as "mouse_click" | "mouse_up" | "mouse_scroll" | "mouse_drag" | "monitor_touch" | "mouse_move";
    }
...
export class TurtleInventoryEvent implements IEvent {
    ...
    public get_name(): "turtle_inventory" {return "turtle_inventory";}
    public get_args() {return [];}
    public static init(args: any[]): IEvent | null {
...
class SpeakerAudioEmptyEvent implements IEvent {
    ...
    public get_name(): "speaker_audio_empty" {return "speaker_audio_empty";}
    public get_args() {return [this.side];}
    public static init(args: any[]): IEvent | null {
...
class ComputerCommandEvent implements IEvent {
    ...
    public get_name(): "computer_command" {return "computer_command";}
...
type AnyEvent = CharEvent | KeyEvent | PasteEvent | TimerEvent | TaskCompleteEvent | RedstoneEvent | TerminateEvent | DiskEvent | PeripheralEvent | RednetMessageEvent | ModemMessageEvent | HTTPEvent | WebSocketEvent | MouseEvent | ResizeEvent | TurtleInventoryEvent | SpeakerAudioEmptyEvent | ComputerCommandEvent | GenericEvent;
