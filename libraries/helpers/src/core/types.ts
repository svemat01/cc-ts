...
declare global {
    namespace CC {
         ...
         * @example
         * ```typescript
         * const monitor = peripheral.wrap<Monitor>("top" as CC.Side);
         * ```
         */
        type Side =
            | "top"
         ...
         */
        type TransferredFile = ReadFileHandle & {
            getName: () => string;
        };
    }
    ...
    namespace os {
        interface Events {
             ...
             */
            disk: [side: /** The side the disk was attached to */ CC.Side];
            /**
             * @see https://tweaked.cc/event/disk_eject.html
             */
            disk_eject: [
                side: /** The side of the disk drive that had a disk removed */ CC.Side
            ];
            /**
             * @see https://tweaked.cc/event/file_transfer.html
             */
            file_transfer: [files: CC.TransferredFiles];
            /**
             ...
             */
            modem_message: [
                side: /** The side of the modem that received the message */ CC.Side,
             ...
             */
            monitor_resize: [
                side: /** The side of the monitor that was resized */ CC.Side
            ];
            /**
             * @see https://tweaked.cc/event/monitor_touch.html
             */
            monitor_touch: [
                side: /** The side or network ID of the monitor that was touched */ CC.Side,
             ...
             */
            mouse_click: [
                button: /** The mouse button that was clicked */ CC.MouseButton,
             ...
             */
            mouse_up: [
                button: /** The mouse button that was released */ CC.MouseButton,
             ...
             */
            peripheral: [
                side: /** The side the peripheral that was attached to */ CC.Side
            ];
            /**
             * @see https://tweaked.cc/event/peripheral_detach.html
             */
            peripheral_detach: [
                side: /** The side the peripheral that was detached from */ CC.Side
            ];
            /**
             ...
             */
            speaker_audio_empty: [
                side: /** The name of the speaker which is available to play more audio. */ CC.Side
            ];
            /**
        ...
        function pullEvent<TEvent extends keyof Events>(
            filter: TEvent
        ): LuaMultiReturn<[TEvent, ...Events[TEvent]]>;
    }

    namespace peripheral {
        interface Peripherals {
            command: CommandPeripheral;
            computer: ComputerPeripheral;
            drive: DrivePeripheral;
            modem: ModemPeripheral;
            wired_modem: WiredModemPeripheral;
            monitor: MonitorPeripheral;
            printer: PrinterPeripheral;
            speaker: SpeakerPeripheral;
            energy_storage: EnergyStoragePeripheral;
            fluid_storage: FluidStoragePeripheral;
            inventory: InventoryPeripheral;
            [name: string & {}]: IPeripheral;
        }
    }
}
